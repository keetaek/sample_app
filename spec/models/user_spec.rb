...
describe User do
  ...
  it "should reject invalid email addresses" do 
    addresses = %w[user@foo,com The_USERfoo.bar.org first.last@foot.]
    addresses.each do |address|
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email address with no user" do
        nonexistent_email = User.authenticate("invalidEmail", "whatever_password")
        nonexistent_email.should be_nil
      end
      it "should return the user on email/password match" do
        correct_email_password = User.authenticate(@attr[:email], @attr[:password])
        correct_email_password.should == @user
      end
    end
